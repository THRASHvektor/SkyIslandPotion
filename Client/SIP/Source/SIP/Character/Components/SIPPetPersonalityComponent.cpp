...
#include "Character/Components/SIPPetPersonalityComponent.h"
...
void USIPPetPersonalityComponent::GeneratePersonalityFromPrompt(const FString& Prompt)
{
	...
	if (PromptContainsAny(LowerPrompt, {TEXT("protect"), TEXT("guardian"), TEXT("loyal"), TEXT("safe"), TEXT("保护"), TEXT("守护"), TEXT("忠诚")}))
	{
		PersonalityType = ESIPPetPersonalityType::Protective;
	}
	else if (PromptContainsAny(LowerPrompt, {TEXT("brave"), TEXT("bold"), TEXT("fighter"), TEXT("combat"), TEXT("勇敢"), TEXT("战斗")}))
	{
		PersonalityType = ESIPPetPersonalityType::Brave;
	}
	else if (PromptContainsAny(LowerPrompt, {TEXT("timid"), TEXT("shy"), TEXT("careful"), TEXT("scared"), TEXT("胆小"), TEXT("谨慎")}))
	{
		PersonalityType = ESIPPetPersonalityType::Timid;
	}
	else if (PromptContainsAny(LowerPrompt, {TEXT("independent"), TEXT("free"), TEXT("scout"), TEXT("solo"), TEXT("独立"), TEXT("侦察")}))
	{
		PersonalityType = ESIPPetPersonalityType::Independent;
	}
	else if (PromptContainsAny(LowerPrompt, {TEXT("gentle"), TEXT("kind"), TEXT("heal"), TEXT("soft"), TEXT("温柔"), TEXT("治疗")}))
	{
...
{
	Traits = FSIPPetPersonalityTraits();
