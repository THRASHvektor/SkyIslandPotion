...
FSIPPetPersonalityConfig USIPPetPersonalityJsonComponent::BuildConfigFromPrompt(const FString& Prompt) const
{
	...
	if (ContainsAny(LowerPrompt, {TEXT("rock"), TEXT("stone"), TEXT("earth"), TEXT("岩"), TEXT("石"), TEXT("土"), TEXT("稳定")}))
	{
	...
	else if (ContainsAny(LowerPrompt, {TEXT("water"), TEXT("heal"), TEXT("blue"), TEXT("水"), TEXT("治疗"), TEXT("治愈"), TEXT("温柔")}))
	{
	...
	else if (ContainsAny(LowerPrompt, {TEXT("thunder"), TEXT("lightning"), TEXT("electric"), TEXT("雷"), TEXT("电"), TEXT("爆发"), TEXT("勇敢")}))
	{
	...
	else if (ContainsAny(LowerPrompt, {TEXT("plant"), TEXT("leaf"), TEXT("flower"), TEXT("vine"), TEXT("草"), TEXT("花"), TEXT("植物"), TEXT("藤"), TEXT("资源")}))
	{
	...
	else if (ContainsAny(LowerPrompt, {TEXT("shadow"), TEXT("dark"), TEXT("stealth"), TEXT("mist"), TEXT("影"), TEXT("暗"), TEXT("雾"), TEXT("隐秘"), TEXT("侦察")}))
	{
...
void USIPPetPersonalityJsonComponent::ApplyColorToOwnerMeshes(const FLinearColor& Color) const
{
	...
	if (bShowRuntimeDebugMessage && GEngine)
	{
		const FColor DebugColor = Color.ToFColor(true);
		const FString Message = FString::Printf(TEXT("Pet color applied: %s = %s"), *ElementToString(CurrentConfig.Element), *ColorToHex(Color));
		GEngine->AddOnScreenDebugMessage(reinterpret_cast<uint64>(this), 3.0f, DebugColor, Message);
	}
}
...
FLinearColor USIPPetPersonalityJsonComponent::GetPaletteColorForElement(ESIPPetElementType Element) const
{
	...
	case ESIPPetElementType::Rock:
		return FLinearColor(0.60f, 0.42f, 0.22f, 1.0f);
	case ESIPPetElementType::Water:
		return FLinearColor(0.12f, 0.55f, 1.0f, 1.0f);
	case ESIPPetElementType::Thunder:
		return FLinearColor(1.0f, 0.78f, 0.08f, 1.0f);
	case ESIPPetElementType::Plant:
		return FLinearColor(0.32f, 0.95f, 0.18f, 1.0f);
	case ESIPPetElementType::Shadow:
		return FLinearColor(0.24f, 0.08f, 0.55f, 1.0f);
