...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Pet AI", meta = (AllowPrivateAccess = "true"))
	TObjectPtr<USIPPetMoodComponent> MoodComponent;
};
