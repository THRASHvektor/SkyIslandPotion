...
**状态**：已拍板，设计 v2（视频爬取剔除，改为人工维护链接清单）
**日期**：2026-06-22
...
┌─────────────────────────────────────────────────────────────┐
│  ue-discovery (新)                                           │
│  种子源：Reddit r/UnrealEngine / X 上的 UE list / RSS / GitHub│
│  （视频源已剔除自动轮询，改为人工维护 video-links.md）         │
│  去重 + UE 主题过滤 + 相关度评分                              │
...
┌─────────────────────────────────────────────────────────────┐
│  人工下载 + 视频链接人工维护                                  │
│  - 视频下载：人做（yt-dlp / 浏览器，人随意选）                 │
│  - 视频链接清单：人工维护 video-links.md                      │
